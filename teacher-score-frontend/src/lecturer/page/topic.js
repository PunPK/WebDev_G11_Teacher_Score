  ...
  return (
    <>
      ...
      <div class="grid bg-gradient-to-tr from-red-400 to-pink-500 min-h-screen max-h-full top-0 mt-0 z-10">
        ...
        <Card className="mt-1 mx-auto w-auto h-24 shadow-xl bg-white mb-6">
        ...
        <div className="flex gap-4 mb-4 mx-[8.5rem] h-12 ">
          ...
          <Card
            className="flex-none group w-14 items-center justify-center"
          >
            <CardBody>
              <Typography
                vatiant="h5"
            ...
            {topicData.map((user) => (
              <>
                <div className="flex gap-4 w-auto my-4 h-12">
                  ...
                  <Card
                    className="flex-none group w-48 text-center  bg-gradient-to-tr from-blue-50 hover:drop-shadow-5xl items-start justify-center"
                  >
                    <div className="my-auto mx-auto">
                      <CardBody>
                        <Typography
                  ...
                  <Card
                    className="flex-none group w-44 text-center  bg-gradient-to-tr from-blue-50 hover:drop-shadow-5xl items-center justify-center"
                  >
                    <CardBody>
                      <Typography
                        vatiant="h5"
                  ...
                  <Card
                    ...
                    className="flex-none group w-14 bg-gradient-to-tr from-blue-500 to-blue-900 hover:-translate-y-2 transition-all duration-200 delay-75 hover:drop-shadow-5xl cursor-pointer  hover:bg-gradient-to-tr hover:from-red-700 hover:to-pink-900  hover:shadow-red-400 items-center justify-center"
                  >
                    <CardBody>
                      <Typography
                        vatiant="h5"
                  ...
                  <Card
                    onClick={() => navigate(`/edit/${user.documentId}`)}
                    className="flex-none group w-14 bg-gradient-to-tr from-red-500 to-red-900 hover:-translate-y-2 transition-all duration-200 delay-75 hover:drop-shadow-5xl cursor-pointer  hover:bg-gradient-to-tr hover:from-red-700 hover:to-pink-900  hover:shadow-red-400 items-center justify-center"
                  >
                    <CardBody>
                      <Typography
                        vatiant="h5"
