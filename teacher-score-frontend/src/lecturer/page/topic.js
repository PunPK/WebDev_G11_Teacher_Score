              ...
              <>
                <div className="flex gap-4 w-auto my-4 h-12">
                  ...
                  <Card
                    ...
                    className="flex-none group w-14 bg-gradient-to-tr from-blue-500 to-blue-900 hover:-translate-y-0.5 transition-all duration-200 delay-75 hover:drop-shadow-5xl cursor-pointer  hover:bg-gradient-to-tr hover:from-red-700 hover:to-pink-900  hover:shadow-red-400 items-center justify-center"
                  >
                    <CardBody>
                      <Typography
                        vatiant="h5"
