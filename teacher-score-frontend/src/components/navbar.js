  ...
  return (
    <header className="bg-white/90 drop-shadow-sm  w-full h-1/6 sticky z-20 top-0 md:w-auto">
      <div
        id="sticky-banner"
        tabIndex="-1 n"
        className=" max-w-7xl w-full  mx-auto px-2 sm:px-6 lg:px-8  "
      >
        <div className=" flex items-center mx-6 h-12 justify-between">
          ...
          <div className="absolute inset-y-0 flex right-0 items-center pr-2 mr-4 my-2 w-18">
            <button
              onClick={onLogout}
              className="items-center hover:bg-light-blue-400/20 hover:text-black bg-transparent text-black hover:ring-1 hover:ring-offset-2 hover:ring-black/45  w-20 rounded-lg h-7 my-auto"
            >
              <div className="my-1">
                <a
                  href="/"
                  className="items-center no-underline hover:no-underline justify-items-center my-1 mx-auto"
                >
                  Logout
                </a>
              </div>
